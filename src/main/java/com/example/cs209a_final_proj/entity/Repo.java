...
public class Repo {
    ...
    public Repo(int repo_id, String repo_name, int total_developers, int total_open_issues, int total_closed_issues, int total_releases, float issue_resolution_time) {
