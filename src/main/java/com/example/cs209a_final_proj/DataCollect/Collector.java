...
public class Collector {
        ...
        try {
            ...
            for (JsonElement jsonElement : jsonArray) {
                ...
                if (con != null) {
                    ...
                    stmt.execute("insert into release(repo_id, release_id, release_name, released_at,commit_between_release) values ("
                            + String.valueOf(repo_id) + "," + release_id + ",'" + release_name + "','" + released_at + "',null)");
                    stmt.close();
                }
            ...
            for (JsonElement jsonElement : jsonArray) {
                ...
                if (con != null) {
                    ...
                    if (closed_at_s == null) {
                        ...
                        stmt.execute(
                                "insert into issue(repo_id,issue_id,issue_number,comment_number,title,state,create_at,closed_at) values("
                                        + String.valueOf(repo_id) + "," + String.valueOf(issue_id) + "," + String.valueOf(issue_number) + ","
                                        + String.valueOf(comment_number) + ",'" + title + "','" + state + "','"
                                        + created_at_s + "','" + closed_at_s + "')");
                    }
    ...
    private static void addCommitBetweenRelease() {
        ...
        try {
            ...
            stmt.execute("update release set commit_between_release =table5.commit_between_release from\n" +
    ...
    private static void insertRepo(){
        ...
        try {
            Statement stmt = con.createStatement();
            stmt.execute("insert into repo(repo_id,repo_name) values ("+String.valueOf(repo_id)+",'"+path+"')");
            stmt.close();
        } catch (Exception e) {
            System.out.println(e);
        }
